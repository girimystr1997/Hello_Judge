...
public class Qr_code extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(Qr_code.this)
                .setMessage(message)
    ...
    public void handleResult(Result rawResult) {
       ...
       dbb = rawResult.getText();
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mScannerView.resumeCameraPreview(Qr_code.this);
            }
        });
        builder.setNeutralButton("Visit", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(dbb));
    ...
    private class Send extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                String up = "insert into multimedia(id)values('" + dbb + "')";
                ...
                while (rs.next()) {
                    ...
                    Intent intent = new Intent(Qr_code.this, Judge.class);
