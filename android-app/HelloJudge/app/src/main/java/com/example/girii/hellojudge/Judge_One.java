...
public class Judge_One extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.girii.hellojudge.R.layout.judge_one);
        ...
        demoRef = rootRef.child("participents").child(scanedOutput);
//        new Send().execute();
